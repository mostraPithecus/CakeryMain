    ...
    <div className="bg-gradient-to-br from-violet-50 via-rose-50 to-amber-50 relative min-h-screen animate-fadeIn"> 
      ...
      {showFloatingSwitch && ( 
        <div className="fixed bottom-0 left-0 right-0 z-50">
          <div className="bg-gradient-to-r from-[#8148B5] via-[#B671D1] to-[#E57D8D] p-3 shadow-lg">
            <div className="container mx-auto px-4 flex justify-between items-center">
              <button
                onClick={() => {
                  document.getElementById('order-section')?.scrollIntoView({ behavior: 'smooth' });
                }}
                className="px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-md backdrop-blur-sm transition-all duration-300 flex items-center gap-2 border border-white/20"
              >
      ...
      <div className="relative"> 
        {/* Catalog Controls */} 
        <div id="portfolio-section" className="py-12 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl shadow-lg overflow-hidden border border-purple-100 mx-4 my-8"> 
          <div className="max-w-7xl mx-auto px-4 md:px-8"> 
            {/* Mode Switch */} 
            <div className="flex justify-between items-center mb-6"> 
              <div>
                <span className="inline-block px-4 py-1 bg-purple-100 text-[#8148B5] rounded-full text-sm font-medium mb-2">PORTFOLIO</span>
                <h2 className="text-2xl font-bold text-gray-800">Our Cake Gallery</h2>
              </div>
            ...
            <div className="relative z-40"> 
              <div className="flex items-center justify-between">
                <button 
                  ...
                  className="flex items-center space-x-2 px-4 py-2.5 bg-white/80 backdrop-blur-sm border border-gray-300 rounded-md hover:bg-white hover:border-gray-400 shadow-sm transition-all w-full md:w-auto md:hidden" 
                > 
              ...
              {isFilterMenuOpen && ( 
                <div className="fixed inset-0 z-50 md:hidden">
                  ...
                  {/* Menu content */}
                  <div className="absolute left-4 right-4 top-1/4 bg-white rounded-xl shadow-xl py-3 max-h-[60vh] overflow-y-auto">
                    <div className="flex items-center justify-between px-4 pb-2 border-b">
                      <h3 className="font-medium text-gray-900">Cake Categories</h3>
                      <button 
                        onClick={() => setIsFilterMenuOpen(false)}
                    ...
                    <div className="py-2">
                      <button 
                        ...
                        className={`w-full text-left px-4 py-3 hover:bg-purple-50 transition-colors
                          ${!selectedCategory ? 'text-[#8148B5] font-medium border-l-4 border-[#8148B5]' : 'text-gray-700 border-l-4 border-transparent'}`} 
                      > 
                        All Categories 
                      </button> 
                      {categories.map((category) => ( 
                        <button 
                          ...
                          className={`w-full text-left px-4 py-3 hover:bg-purple-50 transition-colors
                            ${selectedCategory === category.id ? 'text-[#8148B5] font-medium border-l-4 border-[#8148B5]' : 'text-gray-700 border-l-4 border-transparent'}`} 
                        > 
                          {category.name} 
                        </button> 
                      ))} 
              ...
              <div className="hidden md:flex flex-wrap gap-2 mt-4"> 
                <button 
                  ...
                  className={`px-4 py-2 rounded-md transition-all duration-300 border backdrop-blur-sm ${
                    !selectedCategory
                      ? 'bg-[#8148B5]/10 text-[#8148B5] font-medium border-[#8148B5]/30 shadow-sm'
        ...
        {/* Add consultation button inside the portfolio section */}
      ...
      {selectedItem && ( 
        <Dialog open={!!selectedItem} onClose={() => setSelectedItem(null)} className="relative z-50"> 
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4"> 
            <Dialog.Panel className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden">
              <button  
